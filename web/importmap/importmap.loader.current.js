(function (isProd) {
  const maps = {
    dev: './importmap/index.dev.importmap',
    prod: './importmap/index.prod.importmap',
  };
  ...
  */
  ...
  globalThis.importMapLoader = fetch(isProd ? maps.prod : maps.dev)
    ...
    .then(resp => {
      const el = document.createElement('script');
      el.type = 'importmap';
      el['nonce'] = 'a5397dc0fca7487da4b6cdb380f89baa';
      el.setAttribute('nonce', 'a5397dc0fca7487da4b6cdb380f89baa');
      el.textContent = resp;
